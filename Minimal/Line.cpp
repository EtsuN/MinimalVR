...
// Define the coordinates and indices needed to draw the Line. Note that it is not necessary
...
void Line::draw(GLuint shaderProgram, const glm::mat4& projection, const glm::mat4& view) {
	...
	glDrawArrays(GL_LINES, 0, 2); // 3 vertices per triangle, 2 triangles per face, 6 faces
